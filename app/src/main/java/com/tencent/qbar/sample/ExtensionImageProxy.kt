...
private fun ImageProxy.toBitmap(): Bitmap? {
    val nv21: ByteArray = toFormatToNv21()
...
fun ImageProxy.toFormatToNv21(): ByteArray {
    if (this.format != ImageFormat.YUV_420_888) {
        throw IllegalArgumentException("ImageProxy format must be YUV_420_888")
    }
